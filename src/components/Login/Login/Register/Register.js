        ...
        <Container component="main" maxWidth="xs">
            <CssBaseline />
            {
                user?.email ? <UserProfile /> : (
                    ...
                    >
                        <Avatar sx={{ m: 1, bgcolor: blue[400], transition: '0.3s', '&:hover': { bgcolor: blue[600] } }}>
                            <LockOutlinedIcon />
                        </Avatar>
                        ...
                        <Box component="form" noValidate onSubmit={handleRegister} sx={{ mt: 3 }}>
                            ...
                            <Grid container justifyContent="flex-end">
                                <Grid item>
                                    <Button onClick={() => toggleLogin(false)} sx={{ color: blue[500], '&:hover': { color: blue[700] } }}>
